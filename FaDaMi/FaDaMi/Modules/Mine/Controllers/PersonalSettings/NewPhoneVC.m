...
- (void)initUI {
    ...
    _codeStr = @"";
    UIView *headView = [[UIView alloc] initWithFrame:CGRectMake(0, 74, SCREENWIDTH, 106)];
    headView.backgroundColor  = [UIColor whiteColor];
    [self.view addSubview:headView];
    
    UIView *oneView = [[UIView alloc] initWithFrame:CGRectMake(15, 10,SCREENWIDTH-30 , 45)];
    ...
    UIView *twoView = [[UIView alloc] initWithFrame:CGRectMake(15, 65, SCREENWIDTH - 30 , 45)];
    ...
    _commitBtn.frame = CGRectMake(15, Orgin_y(headView) +20, SCREENWIDTH - 30 , 45);
...
- (void)replaceBtnEvent:(id)sender { WEAKSELF
