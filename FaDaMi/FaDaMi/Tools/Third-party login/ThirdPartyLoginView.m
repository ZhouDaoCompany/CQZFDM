...
- (void)initUI
{
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(15, 12.f, (SCREENWIDTH - 135)/2.f, line_w)];
    ...
    UIView *lineView1 = [[UIView alloc] initWithFrame:CGRectMake(Orgin_x(lab), 12.f, (SCREENWIDTH - 135)/2.f, line_w)];
    ...
    for (NSUInteger index = 0; index <_items.count; index ++) {
        ...
        CGRect toRect = CGRectMake((SCREENWIDTH - 280)/2.f + 100*index, 45, 80, 80);
...
- (void)thirdLoginActionWithPlatformType:(UMSocialPlatformType)platformType
    ...
    [[UMSocialManager defaultManager] getUserInfoWithPlatform:platformType currentViewController:_superVC completion:^(id result, NSError *error) {
