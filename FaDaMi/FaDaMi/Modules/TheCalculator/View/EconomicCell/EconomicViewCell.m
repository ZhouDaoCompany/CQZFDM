    ...
    if (section == 0) {
        ...
        switch (row) {
            case 0:
            {
                ...
                _textField.frame = CGRectMake(SCREENWIDTH - 135, 7, 120, 30);
            ...
            case 2:
            {
                ...
                _textField.frame = CGRectMake(SCREENWIDTH - 200, 7, 185, 30);
                self.accessoryType = UITableViewCellAccessoryNone;
...
{
    if (!_textField) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(SCREENWIDTH - 155, 7, 120, 30)];
