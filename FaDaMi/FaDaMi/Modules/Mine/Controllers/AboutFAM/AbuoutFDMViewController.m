...
@interface AbuoutFDMViewController ()<UITableViewDataSource,UITableViewDelegate,SKStoreProductViewControllerDelegate>
...
@implementation AbuoutFDMViewController
...
- (void)initUI {
    ...
    [self setupNaviBarWithTitle:@"关于法大秘"];
    ...
    UILabel *lab = [[UILabel alloc] initWithFrame:CGRectMake(60, Orgin_y(_versionLab)+2 ,SCREENWIDTH - 120 , 18)];
    lab.textColor = _versionLab.textColor;
    lab.text = [NSString stringWithFormat:@"版本号: V%@",[QZManager getBuildVersion]];
    ...
    shadowImg.center =  CGPointMake(SCREENWIDTH/2.f, _logoImgView.center.y + 37);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(15, 43.5f, SCREENWIDTH-15.f, .5f)];
...
- (UIImageView *)logoImgView {
    ...
    if (!_logoImgView) {
        _logoImgView = [[UIImageView alloc] initWithFrame:CGRectMake((SCREENWIDTH - 74.f)/2.f, 134, 74, 74)];
...
- (UILabel *)versionLab {
    ...
    if (!_versionLab) {
        _versionLab = [[UILabel alloc] initWithFrame:CGRectMake(60, 233, SCREENWIDTH - 120, 20)];
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0,Orgin_y(_versionLab) +45, SCREENWIDTH, 90) style:UITableViewStylePlain];
