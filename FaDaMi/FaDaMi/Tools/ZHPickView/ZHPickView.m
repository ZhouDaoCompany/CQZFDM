...
- (void)setDateViewWithTitle:(NSString *)title {
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, Orgin_y(header), SCREENWIDTH, .5f)];
...
- (void)setDataViewWithItem:(NSArray *)items title:(NSString *)title {
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 39.5f, SCREENWIDTH, .5f)];
    lineView.backgroundColor = LINECOLOR;
