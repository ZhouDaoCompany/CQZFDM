...
@property (nonatomic, copy) NSString *typeString;//职业类型
...
- (UIView *)bottomView{
    ...
    if (!_bottomView) {
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(25, 194, SCREENWIDTH -50, 160)];
...
- (UIImageView *)logoImgView {
    ...
    if (!_logoImgView) {
        _logoImgView = [[UIImageView alloc] initWithFrame:CGRectMake((SCREENWIDTH -74)/2.f, 84, 74, 74)];
...
- (UIImageView *)eyeImgView { WEAKSELF
    ...
    if (!_eyeImgView) {
        ...
        [_eyeImgView whenTapped:^{
            ...
            if (weakSelf.isLook == YES) {
                weakSelf.eyeImgView.image = [UIImage imageNamed:@"find_eye"];
                weakSelf.keyText.secureTextEntry = YES;
            }else {
                weakSelf.eyeImgView.image = [UIImage imageNamed:@"find_eyeSelect"];
...
- (UILabel *)professionalLab { WEAKSELF
...
- (UIButton *)registerBtn
{
    if (!_registerBtn) {
        ...
        _registerBtn.frame = CGRectMake(26, 375, SCREENWIDTH - 52, 40);
...
- (UIButton *)goLoginBtn
{
    if (!_goLoginBtn) {
        ...
        _goLoginBtn.frame = CGRectMake(26, 430, SCREENWIDTH - 52, 40);
...
- (void)allBtnEvent:(id)sender { WEAKSELF
