...
- (void)initUI {
    ...
    [self setupNaviBarWithColor:[UIColor whiteColor]];
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 64, SCREENWIDTH, .6f)];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    UIView *views = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, .1f)];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0,64.6f, SCREENWIDTH, SCREENHEIGHT-64.6f) style:UITableViewStyleGrouped];
