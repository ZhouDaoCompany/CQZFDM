...
- (void)otherApplicationsToOpenwithURLString:(NSURL *)urlString{
    ...
    [_documentInteractionController presentOpenInMenuFromRect:CGRectMake(0, 64, SCREENWIDTH, SCREENHEIGHT - 64.f) inView:self.view animated:YES];
}
...
{
    return CGRectMake(0, 64, SCREENWIDTH, SCREENHEIGHT - 64.f);
}
...
{
    if (!_downView) {
        _downView = [[DownLoadView alloc] initWithFrame:SCREENFRAMERECT];
...
{
    if (!_titLabel) {
        _titLabel = [[UILabel alloc] initWithFrame:CGRectMake(30,94 , SCREENWIDTH - 60, 20)];
...
- (UIImageView *)wordImgView
{
    if (!_wordImgView) {
        ...
        _wordImgView = [[UIImageView alloc] initWithFrame:CGRectMake((SCREENWIDTH - 153.f)/2.f, 139, 153.f, 145.f)];
...
- (UIButton *)openBtn
{
    if (!_openBtn) {
        ...
        _openBtn.frame = CGRectMake(60, Orgin_y(_wordImgView) + 25, SCREENWIDTH - 120, 45);
