...
- (UIImageView *)pics {
    ...
    if (!_pics) {
        ...
        _pics = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, (SCREENWIDTH - 60) / 5, (SCREENHEIGHT - 60) / 5)];
...
- (UIButton *)removeBtn {
    ...
    if (!_removeBtn) {
        ...
        _removeBtn = [[UIButton alloc]initWithFrame:CGRectMake((SCREENWIDTH - 60) / 5 -20, 0, 20, 20)];
