...
- (void)initUI
{
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 18, SCREENWIDTH - 60, 20)];
    ...
    UILabel *moneyLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, Orgin_y(titleLabel), SCREENWIDTH - 60, 20)];
...
{
    BreachHeadView *secitionView = [[BreachHeadView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 75.f) WithMoney:_detailDictionary[@"AllMoney"] withDate:_detailDictionary[@"AllDays"] withRate:_detailDictionary[@"ReatType"]];
    return secitionView;
}
...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        _headerView = [ParallaxHeaderView parallaxHeaderViewWithImage:[QZManager createImageWithColor:hexColor(00c8aa) size:CGSizeMake(SCREENWIDTH, 100)] forSize:CGSizeMake(SCREENWIDTH, 100)];
...
{
    if (!_bottomLabel) {
        _bottomLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, SCREENWIDTH-20, 30)];
