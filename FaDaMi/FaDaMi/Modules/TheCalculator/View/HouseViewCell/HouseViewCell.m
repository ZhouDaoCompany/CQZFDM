...
- (void)settingHouseCellUIWithSection:(NSInteger)section withRow:(NSInteger)row withNSMutableArray:(NSMutableArray *)arrays
{
    ...
    if (section == 0) {
        ...
        _lineView.frame = CGRectMake(15, 44.4f, SCREENWIDTH - 15, .6f);
        _lineView.hidden = NO;
       ...
       if ([arr1[0] isEqualToString:@"组合贷款"]){
           ...
           switch (row) {
               case 0:
               {
                   ...
                   _textField.frame = CGRectMake(SCREENWIDTH - 175, 7, 140, 30);
               ...
               case 2:
               {
                   ...
                   _textField.frame = CGRectMake(SCREENWIDTH - 175, 7, 160, 30);
        ...
        switch (row) {
            case 0:
            {
                _titleLab.frame = CGRectMake(15, 12, SCREENWIDTH - 30, 20);
                _segButton.hidden = NO;
                _segButton.frame = CGRectMake((SCREENWIDTH - 180)/2.f, Orgin_y(_titleLab) + 10, 180, 25);
...
{
    if (!_manualLabel) {
        _manualLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREENWIDTH - 210, 12, 115, 20)];
...
{
    if (!_symbolLabel) {
        _symbolLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREENWIDTH - 26, 12, 13, 20)];
        _symbolLabel.text = @"%";
...
{
    if (!_textField) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(SCREENWIDTH - 135, 7, 120, 30)];
        _textField.borderStyle = UITextBorderStyleNone;
...
- (UISegmentedControl *)segButton
{
    if (!_segButton) {
        ...
        _segButton.frame = CGRectMake(SCREENWIDTH - 102, 9, 87, 27);
