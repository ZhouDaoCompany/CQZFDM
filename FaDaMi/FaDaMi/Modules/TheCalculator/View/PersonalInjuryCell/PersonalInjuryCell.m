...
- (void)settingDetailViewUIWithSection:(NSInteger)section withRow:(NSInteger)row WithMutableArrays:(NSMutableArray *)arrays
{
    ...
    _textField.frame = CGRectMake(SCREENWIDTH - 160, 7, 145, 30);
    ...
    if (section == 0) {
        ...
        switch (row) {
            case 0:
            {
                ...
                _textField.frame = CGRectMake(SCREENWIDTH - 215, 7, 180, 30);
            ...
            case 5:
            {
                ...
                if ([arr1[4] integerValue] == 0) {
                    ...
                    if (levelArr.count == 0) {
                        ...
                        lab.frame = CGRectMake(SCREENWIDTH - 175, 7, 130, 30);
                        lab.font = Font_14;
...
{
    if (!_textField) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(SCREENWIDTH - 215, 7, 180, 30)];
...
- (UISegmentedControl *)segButton
{
    if (!_segButton) {
        ...
        _segButton.frame = CGRectMake(SCREENWIDTH - 122, 9, 107, 27);
