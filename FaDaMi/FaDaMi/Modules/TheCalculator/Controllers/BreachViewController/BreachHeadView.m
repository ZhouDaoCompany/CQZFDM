...
{
    UIView *view1 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 45.f)];
    ...
    UILabel *lab2 = [[UILabel alloc] initWithFrame:CGRectMake(Orgin_x(lineView1), 7.5f, SCREENWIDTH - 187.2f, 30)];
    ...
    float width = (SCREENWIDTH - 145.f)/3.f;
