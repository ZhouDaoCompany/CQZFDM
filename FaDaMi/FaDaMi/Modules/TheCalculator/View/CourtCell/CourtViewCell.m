        ...
        if ([arr1[0] isEqualToString:@"财产案件"] || [arr1[0] isEqualToString:@"支付令"]) {
            ...
            switch (row) {
                case 0:
                {
                    ...
                    _textField.frame = CGRectMake(SCREENWIDTH - 235, 7, 200, 30);
            ...
            if (arr1.count == 3) {
                ...
                switch (row) {
                    ...
                    case 1:
                    {
                        _textField.enabled = NO;
                        _textField.hidden = YES;
                        _textField.frame = CGRectMake(SCREENWIDTH - 155, 7, 120, 30);
...
{
    if (!_textField) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(SCREENWIDTH - 165, 7, 150, 30)];
...
- (UISegmentedControl *)segButtonTwo
{
    if (!_segButtonTwo) {
        ...
        _segButtonTwo.frame = CGRectMake(SCREENWIDTH - 102, 9, 87, 27);
