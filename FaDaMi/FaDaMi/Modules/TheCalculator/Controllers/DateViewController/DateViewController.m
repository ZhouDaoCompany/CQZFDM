...
{WEAKSELF;
    ...
    [UIView animateWithDuration:0.25f animations:^{
        ...
        weakSelf.bottomView.frame =  CGRectMake((SCREENWIDTH/2.f)*index , 108, SCREENWIDTH/2.f, 1);
...
{
    if (!_bigScrollView) {
        _bigScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0,109.f, SCREENWIDTH, SCREENHEIGHT - 109.f)];
...
- (UIButton *)dateButton
{
    if (!_dateButton) {
        ...
        _dateButton.frame = CGRectMake(SCREENWIDTH/2.f , 64, SCREENWIDTH/2.f, 44);
...
- (UIButton *)dayButton
{
    if (!_dayButton) {
        ...
        _dayButton.frame = CGRectMake(0 , 64, SCREENWIDTH/2.f, 44);
...
{
    if (!_bottomView) {
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, 108, SCREENWIDTH/2.f, 1)];
