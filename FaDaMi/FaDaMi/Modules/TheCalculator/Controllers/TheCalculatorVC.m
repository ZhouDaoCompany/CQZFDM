...
@interface TheCalculatorVC ()<UICollectionViewDataSource,UICollectionViewDelegate,LewReorderableLayoutDelegate, LewReorderableLayoutDataSource>
...
@implementation TheCalculatorVC
...
- (void)initUI {
    ...
    [self setupNaviBarWithTitle:@"计算器"];
...
- (UICollectionView *)collectionView {
    ...
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64 , SCREENWIDTH ,THEPAGEHEIGHT) collectionViewLayout:layout];
