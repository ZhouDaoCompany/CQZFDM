...
-(UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0,64, SCREENWIDTH, SCREENHEIGHT-64.f) style:UITableViewStylePlain];
        ...
        _headerView = [ParallaxHeaderView parallaxHeaderViewWithImage:[QZManager createImageWithColor:hexColor(00c8aa) size:CGSizeMake(SCREENWIDTH, 160)] forSize:CGSizeMake(SCREENWIDTH, 60)];
...
- (UISegmentedControl *)segmentButton
{
    if (!_segmentButton) {
        ...
        _segmentButton.frame = CGRectMake((SCREENWIDTH - 180)/2.f, 10, 180, 25);
