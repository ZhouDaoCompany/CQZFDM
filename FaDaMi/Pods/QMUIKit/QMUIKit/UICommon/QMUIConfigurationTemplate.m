...
+ (void)setupConfigurationTemplate {
    ...
    QMUICMI.backgroundColor = UIColorMakeWithHex(@"#F2F2F2");                       // UIColorForBackground : 全局背景色，用于viewController的背景色
    ...
    QMUICMI.navBarBarTintColor = UIColorMakeWithHex(@"#00c8aa");                                               // NavBarBarTintColor
    ...
    //- QMUICMI.tabBarBarTintColor = nil;    // TabBarBarTintColor
     ...
     QMUICMI.tabBarTintColor = UIColorMakeWithHex(@"#00c8aa");                                            // TabBarTintColor
     QMUICMI.tabBarItemTitleColor = UIColorMakeWithHex(@"#00c8aa");                                      // TabBarItemTitleColor
     QMUICMI.tabBarItemTitleColorSelected = UIColorMakeWithHex(@"#666666");                                         // TabBarItemTitleColorSelected
