...
- (UILabel *)oneLabel
{
    if (!_oneLabel) {
        ...
        _oneLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 8, SCREENWIDTH/2.f, 30)];
...
- (UILabel *)twoLabel
{
    if (!_twoLabel) {
        ...
        _twoLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREENWIDTH/2.f, 8, SCREENWIDTH/2.f, 30)];
