...
- (UITextField *)textField1 {
    if (!_textField1) {
        ...
        _textField1 = [[UITextField alloc] initWithFrame:CGRectMake(TEXTWIDTH + 2, 7, TEXTWIDTH - 19, 30)];
...
- (UITextField *)textField2 {
    if (!_textField2) {
        ...
        _textField2 = [[UITextField alloc] initWithFrame:CGRectMake(TEXTWIDTH *2 + 2, 7, TEXTWIDTH - 19, 30)];
...
- (UIView *)lineView {
    if (!_lineView) {
        _lineView = [[UIView alloc] initWithFrame:CGRectMake(15, 44.4f, SCREENWIDTH - 15, .6f)];
