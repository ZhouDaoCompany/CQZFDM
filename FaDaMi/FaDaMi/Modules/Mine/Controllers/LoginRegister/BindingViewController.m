...
{WEAKSELF;
    ...
    [self.alertLab1 whenTapped:^{
        [UIView animateWithDuration:.25f animations:^{
            weakSelf.bigScrollView.contentOffset = CGPointMake(SCREENWIDTH, 0);
        }];
    }];
...
{
    if (!_iconImgView) {
        _iconImgView = [[UIImageView alloc] initWithFrame:CGRectMake((SCREENWIDTH - 74)/2.f, 114, 74, 74)];
...
- (UIScrollView *)bigScrollView{
    if (!_bigScrollView) {
        _bigScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0,Orgin_y(_iconImgView) + 20, SCREENWIDTH, SCREENHEIGHT - 208)];
...
- (UIView *)bottomView{
    if (!_bottomView) {
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(25, 0, SCREENWIDTH -50, 160)];
...
- (UIButton *)registerBtn
{
    if (!_registerBtn) {
        ...
        _registerBtn.frame = CGRectMake(26, Orgin_y(_bottomView) +15, SCREENWIDTH - 52, 40);
...
{
    if (!_alertLab1) {
        _alertLab1 = [[UILabel alloc] initWithFrame:CGRectMake(26, Orgin_y(_registerBtn) + 15, SCREENWIDTH - 52, 30)];
...
- (UIView *)bottomView2{
    if (!_bottomView2) {
        _bottomView2 = [[UIView alloc] initWithFrame:CGRectMake(25 + SCREENWIDTH, 0, SCREENWIDTH -50, 89)];
...
- (UIButton *)loginBtn
{
    if (!_loginBtn) {
        ...
        _loginBtn.frame = CGRectMake(26 + SCREENWIDTH, Orgin_y(_bottomView2) +15, SCREENWIDTH - 52, 40);
...
{
    if (!_alertLab2) {
        _alertLab2 = [[UILabel alloc] initWithFrame:CGRectMake(26 + SCREENWIDTH, Orgin_y(_loginBtn) + 15, SCREENWIDTH - 52, 30)];
